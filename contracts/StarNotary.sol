...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Star Dom";
    string public constant symbol = "SDM";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        //Check if the owner of _tokenId1 or _tokenId2 is in fact the sender
        require(owner1 == msg.sender || owner2 == msg.sender);

        //Exchange star tokens
